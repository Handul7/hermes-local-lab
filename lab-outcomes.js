...
(() => {
  ...
  cases.forEach((item, index) => {
    ...
    card.append(flow, element('p', '결과물 형태를 설명하는 예시입니다. 실제 AI 실행 결과가 아닙니다.', 'outcome-caption'));
    ...
    links.append(guide, source); card.append(tradeoff, measure, links); examples.append(card); cards.push(card);
